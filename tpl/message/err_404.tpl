    ...
    <div class="err-404">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <p>
                    [{oxmultilang ident="CNC_ERR_404_START_TEXT"}]<br>
                    <a href="[{$oViewConf->getHomeLink()}]" class="btn btn-outline-dark" title="[{oxmultilang ident="CNC_ERR_404_START_BUTTON"}]">[{oxmultilang ident="CNC_ERR_404_START_BUTTON"}]</a>
                </p>

                <p>
                    [{oxmultilang ident="CNC_ERR_404_CONTACT_TEXT"}]<br>
                    <a href="[{oxgetseourl ident=$oViewConf->getSelfLink()|cat:"cl=contact"}]" class="btn btn-outline-dark" title="[{oxmultilang ident="CNC_ERR_404_CONTACT_BUTTON"}]">[{oxmultilang ident="CNC_ERR_404_CONTACT_BUTTON"}]</a>
                </p>
            </div>
            <div class="col-md-6">
