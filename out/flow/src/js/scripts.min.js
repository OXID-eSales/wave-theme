...
+function (a) {
    ...
    var d = [], e = {
        ...
        builtInValidators: {
            ...
            required: {name: "Required", type: "required", message: oFlow.i18n.DD_FORM_VALIDATION_REQUIRED},
            checkone: {
                name: "Checkone",
                type: "minchecked",
                minchecked: 1,
    ...
    a.fn.unveil = function (b, c) {
        function d() {
            var b = j.filter(function () {
                var b = a(this);
                if (!b.is(":hidden")) {
                    var c = f.scrollTop(), d = c + f.height(), e = b.offset().top;
    ...
    function a() {
        ...
        var h = a.width(), i = c.find("> li").not(".moreLinks"), j = 0, k = [];
    ...
    if (p.length && p.find(".dropdown-menu li").click(function (a) {
        ...
        a.preventDefault();
        var b = $(this), c = b.parents("li").first().find(".row.toggable");
